                                    ...
                                    <tr>
                                        ...
                                        <td class="col-6">
                                            @foreach ($day->events as $event)
                                                <div class="mb-1">
                                                    <a href="{{route('schedule-event-edit', $event->id)}}">{{$event->scheduleEventType->title}}: {{$event->musician->first_name ? $event->musician->first_name : $event->musician->last_name}}</a>
                                                </div>
                                            @endforeach
                                        </td>
                                    </tr>
