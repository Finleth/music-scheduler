/*
Report for Administrator users on the Dashboard that shows Total Sales by Buyer by Month.
*/
$(document).ready(function () {
    $(function () {
        ...
        var dataTotal = [];
        $.ajax({
            url: '/api/charts/administrator/daily-sales-by-buyer',
            type: 'get',
            dataType: 'json',
        ...
        function loadChart() {
            ...
            var ctx = document.getElementById("daily_sales_by_buyer").getContext('2d');
